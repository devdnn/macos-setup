...
# Usage: search_files <pattern>
# Example: search_files example

# Search for files containing a specific pattern in their contents
function search_files_containing() {
    grep -rnw . -e "$1"
}

# Usage: search_files_containing <pattern>
# Example: search_files_containing "example text"

# Usage: extract_archive <archive_file>
# Example: extract_archive example.zip
...
# Usage: simple_http_server [port]
# Example: simple_http_server 8080

autoload -U add-zsh-hook
add-zsh-hook precmd precmd_disown

# remove a file in the current directory and all its children
function remove_specific_file() {
